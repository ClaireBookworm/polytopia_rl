...
from semantic_actions import ActionTextEncoder, SemanticActionHead, TextSemanticTribesWrapper
...
if __name__ == "__main__":
    ...
    text_encoder = ActionTextEncoder(model_name=args.text_model)
    ...
    agent = TextSemanticAgent(envs, text_encoder.embedding_dim).to(device)
